...
public class IncrementAndReturnTokenCompilerTest : BaseCompilerTest {
    ...
    [Test]
    public void TestNewPropertyIncrementAndReturn() {
    ...
    [Test]
    public void TestIntegerPropertyIncrementAndReturn() {
    ...
    [Test]
    public void TestFloatPropertyIncrementAndReturn() {
    ...
    [Test]
    public void TestStringPropertyIncrementAndReturn() {
        UnityELExpression<int> expression = CreateExpression<int>("++a");
        int result = expression.Evaluate(evaluator);
    ...
    [Test]
    public void TestExistingDictionaryElementIncrementAndReturn() {
    ...
    [Test]
    public void TestNewDictionaryElementIncrementAndReturn() {
    ...
    [Test]
    public void TestExistingListElementIncrementAndReturn() {
    ...
    [Test]
    public void TestNewListElementIncrementAndReturn() {
    ...
    [Test]
    public void TestArrayElementIncrementAndReturn() {
    ...
    [Test]
    public void TestObjectIncrementAndReturn() {
