...
public class MultiplyAndAssignToken : BinaryToken {
    public override string Name { get { return "multiplyAndAssign"; } }

    public MultiplyAndAssignToken() {
    }

    public MultiplyAndAssignToken(int position, TokenImpl lhs, TokenImpl rhs) : base(position, lhs, rhs) {
    }
