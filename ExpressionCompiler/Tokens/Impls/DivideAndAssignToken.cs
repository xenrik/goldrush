public class DivideAndAssignToken : BinaryToken {
    public override string Name { get { return "divideAndAssign"; } }

    public DivideAndAssignToken() {
    }

    public DivideAndAssignToken(int position, TokenImpl lhs, TokenImpl rhs) : base(position, lhs, rhs) {
    }
