public class ReturnAndDecrementToken : LeftHandUnaryToken {
    public override string Name { get { return "returnAndDecrementToken"; } }

    public ReturnAndDecrementToken() {
    }

    public ReturnAndDecrementToken(int position, TokenImpl lhs) : base(position, lhs) {
    }
